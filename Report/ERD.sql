...
ALTER TABLE Menu ADD CONSTRAINT FKMenu477873 FOREIGN KEY (RestaurantrestId) REFERENCES Restaurant (restId) ON DELETE CASCADE;
...
ALTER TABLE Restaurant ADD CONSTRAINT FKRestaurant429632 FOREIGN KEY (ownerId) REFERENCES Account (userId) ON DELETE CASCADE;
